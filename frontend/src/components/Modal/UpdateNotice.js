...
const UpdateNotice = (props) => {
  ...
  const [updateNoticeData, setUpdateNoticeData] =
    useState(initUpdateNoticeData);
  ...
  const noticeUpdateHandler = async () => {
    const response = await axios
      .post(
        `${process.env.REACT_APP_SERVER_URL}/api/notice/update`,
        JSON.stringify(updateNoticeData),
        {
          headers: {
