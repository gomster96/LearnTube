    ...
    return (
        <div className={courseClass ? courseClass : "courses-item"}>
            ...
            <div className="content-part">
                <span>
                    <Link className={categoryClass ? categoryClass : "categories bg3"} to={catLink ? catLink : "course-categories"}>
                ...
                <ul className="meta-part">
                    ...
                    <li className="ratings">
                        ...
                        <i className="fa fa-star"></i>
                        <i className="fa fa-star"></i>({userRating ? userRating : "05"})
                    </li>
                </ul>
                <h3 className="title">
                ...
                <div className="images mb-32 md-mb-16">
                    ...
                    <span>
                        By {author ? author : "Admin"} in {courseCategory ? courseCategory : "Web Development"}
                    </span>
                </div>
