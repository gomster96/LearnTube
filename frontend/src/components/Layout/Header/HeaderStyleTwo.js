        ...
        <React.Fragment>
            <div className={headerClass ? headerClass : "full-width-header home8-style4 main-home"}>
                <header id="rs-header" className="rs-header">
                                ...
                                <div className="col-lg-4 hidden-md">
                                    <div className="logo-cat-wrap">
                                        ...
                                        <div className="categories-btn">
                                            <button onClick={catBtn} type="button" className="cat-btn">
                                        ...
                                        <div className="main-menu pr-70">
                                            ...
                                            <nav className="rs-menu hidden-md">
                                                <ul className="nav-menu">
                                                    <MenuItems parentMenu={parentMenu} secondParentMenu={secondParentMenu} activeMenu={activeMenu} />
                                                </ul>
                                            </nav>
                                        </div>
                    ...
                    <RSMobileMenu menuOpen={menuOpen} setMenuOpen={setMenuOpen} parentMenu={parentMenu} secondParentMenu={secondParentMenu} headerFullWidth={headerFullWidth} onClick={canvasMenuAdd} />
