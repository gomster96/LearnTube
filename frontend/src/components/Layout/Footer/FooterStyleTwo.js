                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            ...
                            <ul className="site-map">
                                <li>
                                    <Link to="/learntube/course">eLearning School</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/about">About Us</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/course">Courses</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/contact">Become A Teacher</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/blog">Blog</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            ...
                            <ul className="site-map">
                                <li>
                                    <Link to="/learntube/course">All Courses</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/course-categories">Web Development</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/course-categories">Genarel Education</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/course-categories">Digital Marketing</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/course-categories">Web Design</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            ...
                            <ul className="site-map">
                                ...
                                <li>
                                    <Link to="/learntube/team/team-single">Instructor/Student Profile</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/course">Courses</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/shop/checkout">Checkout</Link>
                                </li>
                                <li>
                                    <Link to="/learntube/faq">Faq</Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="col-lg-4 md-mb-20">
                            <div className="copyright text-center md-text-left">
                                <p>
                                    ...
                                    <a href="https://rstheme.com/" target="_blank">
                                        RSTheme
                                    </a>
                                </p>
                            </div>
