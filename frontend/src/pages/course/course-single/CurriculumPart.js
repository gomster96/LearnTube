...
const CurriculumPart = (props) => {
    ...
    const noticeUpdateHandler = (e) => {
        ...
        let body = {
            ...
            title: noticeTitle ? noticeTitle : data.classRoomData.notices[noticeIdx].title,
            content: noticeContent ? noticeContent : data.classRoomData.noties[noticeIdx].content,
        };
        const async = async () => {
            await axios
                                    ...
                                    ? data.classRoomData.notices.map((notices, i) => (
                                          <div className="content">
                                              <div className="clearfix">
                                                                      ...
                                                                      <div className="styled-form">
                                                                          ...
                                                                          <form id="contact-form" method="post" action="#">
                                                                              <div className="row clearfix">
                                                                                  ...
                                                                                  <div className="form-group col-lg-12 mb-25" style={{ paddingBottom: "7rem" }}>
                                                                                      <div className="my-2" style={{ fontSize: "20px" }}>
                                                                                          {data.classRoomData.notices[noticeIdx].content}
                                                                                      </div>
                                                                                  </div>
                                                                              </div>
                                                                              <br></br>
                                                                              <p className="text-muted">
                                                                                  수정시간:
                                                                                  {data.classRoomData.notices[noticeIdx].modDate.split("T")[0] +
                                                                                      " " +
                                                                                      data.classRoomData.notices[noticeIdx].modDate.split("T")[1].split(":")[0] +
                                                                                      ":" +
                                                                                      data.classRoomData.notices[noticeIdx].modDate.split("T")[1].split(":")[1]}
                                                                              </p>
                                                                              <hr></hr>
                                                                              <div className="row d-flex justify-content-end ms-3 me-1 mt-3">
                                                                                  <button
                                                  ...
                                                  <div className="pull-right">
                                                      <div className="minutes" style={{ paddingRight: "15px" }}>
                                                          최종 수정시간:
                                                          {data.classRoomData.notices[i].modDate.split("T")[0] +
                                                              " " +
                                                              data.classRoomData.notices[i].modDate.split("T")[1].split(":")[0] +
                                                              ":" +
                                                              data.classRoomData.notices[i].modDate.split("T")[1].split(":")[1]}
                                                      </div>
                                                  </div>
                                                  {/* 공지 수정 */}
                                                  <Modal
                                                                              ...
                                                                              <div className="row clearfix">
                                                                                  <div className="form-group col-lg-12 mb-25">
                                                                                      ...
                                                                                      <input
                                                                                          ...
                                                                                          id="title"
                                                                                          name="title"
                                                                                          value={noticeTitle ? noticeTitle : data.classRoomData.notices[noticeIdx].title}
                                                                                          onChange={noticeTitleHandler}
                                                                                          placeholder="제목을 입력하세요"
                                                                                          required
                                                                                      />
                                                                                  ...
                                                                                  <div className="form-group col-lg-12">
                                                                                      ...
                                                                                      <textarea
                                                                                          ...
                                                                                          id="description"
                                                                                          name="description"
                                                                                          value={noticeContent ? noticeContent : data.classRoomData.notices[noticeIdx].content}
                                                                                          onChange={noticeContentHandler}
                                                                                          placeholder="설명을 입력하세요"
                                                                                          refs={inputRef}
                                                                                          style={{
                            ...
                            ? data.classRoomData.lectures.map((lectures, i) => (
                                  <AccordionItem className="accordion-item" uuid="c">
                                          ...
                                          <AccordionItemButton>
                                              ...
                                              >
                                                  ...
                                                  >
                                                      ...
                                                      <span
                                                          onClick={() => {
                                                              deleteLecture(data.classRoomData.lectures[i].lectureId);
                                                          }}
                                                      >
                                                          <i
                                                              className="fa fa-trash"
                                      ...
                                      <AccordionItemPanel className="card-body acc-content">
                                          {Array.isArray(data.classRoomData.lectures)
                                              ? data.classRoomData.lectures[i].contents.map((contents, j) => (
                                                    <div className="content">
                                                        <div className="clearfix">
                                                            <ModalVideo
                                                                channel="youtube"
                                                            ...
                                                            <div className="pull-left">
                                                                ...
                                                                >
                                                                    ...
                                                                    {data.classRoomData.lectures[i].contents[j].contentName}
                                                                </Link>
                                                            </div>
                                                            <div className="pull-right">
                                                                <div className="minutes" style={{ paddingTop: "10px" }}>
                                                                    마감일:
                                                                    {data.classRoomData.lectures[i].contents[j].closeDate.split("T")[0] +
                                                                        " " +
                                                                        data.classRoomData.lectures[i].contents[j].closeDate.split("T")[1].split(":")[0] +
                                                                        ":" +
                                                                        data.classRoomData.lectures[i].contents[j].closeDate.split("T")[1].split(":")[1]}
